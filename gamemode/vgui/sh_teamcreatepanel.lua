...
function PANEL:Init()
	...
	self.CreateTeam:SetImage("icon16/add.png")
...
function PANEL:PerformLayout( w, h )
	...
	self.Name:SetSize(390, 22)
	self.Name:SetPos(101, 44)
	
	self.PasswordLabel:SizeToContents()
	self.PasswordLabel:SetTall( 22 )
	self.PasswordLabel:SetPos( 10, 76 )
	self.Password:SetSize(390, 22)
	self.Password:SetPos(101, 76 )
	
	self.CreateTeam:SetPos(370, 108 )
	self.CreateTeam:SetSize(120, 22 )
