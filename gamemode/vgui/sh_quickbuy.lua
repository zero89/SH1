...
function PANEL:Init()
	...
	self.Current:SetColor(Color(0, 0, 0))
...
function PANEL:DoBuy()
	local money = tonumber(LocalPlayer():GetMoney())
	local cost = tonumber(self.m_BuyTbl.price * self.Value:GetValue())
...
function PANEL:PerformLayout( w, h )
	...
	self.Current:SetPos( w-qw-self.Current:GetWide() + 30, 0 )
