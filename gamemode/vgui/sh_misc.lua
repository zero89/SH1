...
function PANEL:Init()
	...
	self.Gradient	= surface.GetTextureID("vgui/gradient-u")
...
function PANEL:Paint( w, h )
	...
	draw.RoundedBox(0, 0, 0, w, h, Color(43,49,54))
	...
	for i=1, 60 do
		...
		lineCol.a = (30 - (math.sin(math.pi/2 - (i/30 * math.pi)) * 30))
...
function PANEL:Think()
	...
	if not self.nextLine or self.nextLine <= CurTime() then
		...
		self.nextLine = CurTime() + 1/60 //Cap at 60fps
