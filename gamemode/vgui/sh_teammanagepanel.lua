...
function PANEL:Init()
	...
	self.ChangePassword:SetImage("icon16/key.png")
	...
	self.KickSelected:SetImage("icon16/user_go.png")
	...
	self.ChangeLeader:SetImage("icon16/arrow_up.png")
	...
	self.LeaderOnlyPass:SetTextColor(Color(0, 0, 0))
	...
	self.DisbandTeam:SetImage("icon16/cross.png")
