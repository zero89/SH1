...
function ENT:Explode()
	...
	effectdata:SetColor( 255,255,255,255)
	--util.Effect( "flash", effectdata, true, true )
	util.Effect( "Tsplode", effectdata, true, true )
...
function ENT:PhysicsUpdate()	
	...
	local endpos 		= tracestart +(self:GetForward() *100)
