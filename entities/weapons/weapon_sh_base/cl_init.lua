...
function SWEP:DrawHUD()
	...
	if self.VElements and self.VElements.scope or self.BuiltInScope then
		...
		if(self.VElements) then
			if self.VElements.scope and !self.Acog and !self.AugRet or self.BuiltInScope then
				-- Draw the crosshair
	...
	if self:GetIronsights() and self.Use3DScope then
