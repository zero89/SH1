...
SWEP.Primary.Round 			= ("tfa_csgo_thrownfrag")
SWEP.WMOffsetPos				= { up = 0, right = 1, forward = 3 }
SWEP.WMOffsetAng				= { up = -1, right = -2, forward = 178 }
...
function SWEP:PostDrawViewModel(ent)
	...
	// ent:SetMaterial("materials/models/weapons/v_models/eq_fraggrenade/fraggrenade.vtf")
	// ent:SetSubMaterial(0, "materials/models/weapons/v_models/eq_fraggrenade/fraggrenade.vtf")
